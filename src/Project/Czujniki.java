...
public class Czujniki {
    public static final String[] czujniki =     {"Prędkość",
                                                "Położenie na torze",
                                                "Odległość do zakrętu i jego kierunek",
                                                "Combo"};
    public static final String[] czujnikiOpis = {"Wskazuje aktualną prędkość pojazdu w km/h.",
                                                "Wskazuje położenie na torze w zakresie od -1 (przy lewej krawędzi toru), " +
                                                        "poprzez 0 (na środku toru) do 1 (przy prawej krawędzi toru).",
                                                "Wskazuje odległość do najbliższego zakrętu i jego kierunek (ujemna wartość - odległość do zakrętu w lewo).",
